...
class Md_information_alkes extends CI_Model {
    ...
    public function MDL_Select() {
        ...
        $sSQL = "
			Select * from ttrs_information_alkes order by recdate desc
		";
    ...
    public function MDL_SelectID($id) {
        $ttrs_information_alkes = $this->config->item('ttrs_information_alkes');

        return $this->db->get_where($ttrs_information_alkes, array('id' => $id))->row();
    }
    ...
    public function MDL_Insert() {
        ...
        $this->db->insert($ttrs_information_alkes, $data);
    }

    public function MDL_isPermInsert($id) {
        $tblName = $this->config->item('ttrs_information_alkes');
    ...
    public function MDL_Update($id) {
        ...
        if ($this->input->post('external_source')) {
            ...
            $link = base_url() . 'information_alkes/CTRL_View/' . $id;
            $external = 0;
        }
        ...
        $this->db->where('id', $id);
        $this->db->update($ttrs_information_alkes, $data);
    }
    ...
    public function MDL_Delete($id) {
        ...
        $this->db->delete($ttrs_information_alkes, array('id' => $id));
    }
