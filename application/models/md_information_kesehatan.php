...
class Md_information extends CI_Model {
    ...
    public function MDL_Select() {
        ...
        $sSQL = "
			Select * from ttrs_information_kesehatan order by recdate desc
		";
    ...
    public function MDL_SelectID($id) {
        $ttrs_information_kesehatan = $this->config->item('ttrs_information_kesehatan');

        return $this->db->get_where($ttrs_information_kesehatan, array('id' => $id))->row();
    }
    ...
    public function MDL_Insert() {
        ...
        if ($this->input->post('external_source')) {
            ...
            $link = base_url() . 'information_kesehatan/CTRL_View/' . $id;
            $external = 0;
        }
        ...
        $this->db->insert($ttrs_information_kesehatan, $data);
    }

    public function MDL_isPermInsert($id) {
        $tblName = $this->config->item('ttrs_information_kesehatan');
    ...
    public function MDL_Update($id) {
        ...
        $this->db->where('id', $id);
        $this->db->update($ttrs_information_kesehatan, $data);
    }
    ...
    public function MDL_Delete($id) {
        ...
        $this->db->delete($ttrs_information_kesehatan, array('id' => $id));
    }
    ...
    public function MDL_getAutoID() {
        ...
        $sSQL = "
			...
			FROM (
				...
				FROM $ttrs_information_kesehatan
			) p
			WHERE 1=1
		";
