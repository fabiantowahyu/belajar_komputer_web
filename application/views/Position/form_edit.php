	...
	<div class="span12 offset panel-box">
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php
						$input = array('name'=>'position_name','value'=>$position_name,'maxlength'=>255,'id'=>'OrgName','class'=>'input-xlarge');
						echo form_input($input);
					?>
				</div>
			</div>
			...
			<div class="form-actions">
				...
				?>
				<button type="submit" name="btn_submit" value="Save" class="btn btn-small btn-info" onclick="SelectAll_Member();"><i class="icon-save"></i> Update</button> &nbsp;
				<?php 
