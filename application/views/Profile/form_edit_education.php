...
<div id="UploadFile" class="row-fluid">
	<div class="span12 offset panel-box">
        ...
        <div class="row-fluid">
            ...
            <div class="control-group">
                <label for="StartDate-Education" class="control-label">Start Date</label>
                <div class="controls">
                    <div class="row-fluid">
                        <?php
            ...
            <div class="control-group">
                <label for="EndDate-Education" class="control-label">End Date</label>
                <div class="controls">
                    <div class="row-fluid">
                        <?php
		...
		<div class="control-group">
			<label for="CertNumber" class="control-label">Number</label>
			<div class="controls">
				<?php
		...
		<div class="control-group">
			<label for="CertDate-Education" class="control-label">Date</label>
			<div class="controls">
				<div class="row-fluid">
					<?php
						$input = array('name'=>'certificate_date','value'=>$certificate_date,'id'=>'CertDate-Education','class'=>'input-small');
						echo form_input($input);
					?>
				</div>
			</div>
