...
<div class="row-fluid">
	<div class="span12 offset panel-box2">
		...
		<?php echo form_open_multipart($url,array('name'=>'myForm','class'=>'form-horizontal','id'=>'validation-form-leader')); ?>
		...
		<div class="row-fluid">
			<div class="span6">
				...
				<div class="control-group">
					<label for="StartDate-Education" class="control-label">Commenced</label>
					<div class="controls">
				...
				<div class="control-group">
					<label for="EndDate-Education" class="control-label">Completed Date</label>
					<div class="controls">
						<div class="row-fluid input-append">
							<?php
			...
			<div class="span6">
				...
				<div class="control-group">
					<label for="TrainingFee" class="control-label">Training Fee</label>
					<div class="controls">
						<?php
