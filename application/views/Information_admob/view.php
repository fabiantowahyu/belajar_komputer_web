...
<div class="row-fluid">
    <h3 class="header smaller lighter blue">
        <?php
        echo anchor('information_admob', $title, array('class' => 'link-control'));
        echo nbs(2);
        echo anchor('information_admob/CTRL_New', '<i class="icon-plus"></i>', array('class' => 'btn btn-danger btn-mini'));
        ?>
    </h3>
        ...
        <tbody>
            ...
            foreach ($results as $row) {
                ...
                <tr>
                    ...
                    <td class="center">
                        <?php
                        echo anchor('information_admob/CTRL_Edit/' . $row->id, '<button class="btn btn-mini btn-info"><i class="icon-edit bigger-120"></i></button>');
