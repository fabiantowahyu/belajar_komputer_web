	...
	<div class="span12 offset panel-box2">
		...
		<fieldset>
            ...
            <div class="control-group">
				...
				<div class="controls">
					<?php
						$input = array('name'=>'template_name','value'=>$template_name,'maxlength'=>100,'id'=>'TemplateName','class'=>'input-large');
						echo form_input($input);
					?>
				</div>
			</div>
            <div class="control-group">
				...
				<div class="controls">
					<?php
						$input = array('name'=>'used_on','value'=>$used_on,'maxlength'=>100,'id'=>'used_on','class'=>'input-large');
						echo form_input($input);
					?>
				</div>
			</div>
