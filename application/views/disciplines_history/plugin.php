...
<link rel="stylesheet" href="<?php echo base_url();?>plugins/jquery-ui/themes/dot-luv/mdp.css">
...
<script src="<?php echo base_url();?>plugins/jquery-ui/ui/jquery-ui-timepicker-addon.js"></script>
<script src="<?php echo base_url();?>plugins/jquery-ui/ui/jquery-ui.multidatespicker.js"></script>
...
<script type="text/javascript">
	$(function() {
		...
		$("#cdelete").on(ace.click_event, function() {
			bootbox.dialog({
				message: "Are you sure want to delete this Disciplines History !",
	...
	$("#start_date,#end_date").datepicker({
		dateFormat : 'yy-mm-dd',
		showOn: "button",
		buttonImage: "<?php echo base_url();?>themes/images/calender.png",
