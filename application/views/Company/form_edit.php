...
<div class="row-fluid">
	<div class="span9 offset2 panel-box2">
		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php
							$input = array('name'=>'name','value'=>$name,'maxlength'=>64,'id'=>'CompanyName','class'=>'input-xlarge');
							echo form_input($input);
						?>
					</div>
				</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php
					$input = array('name'=>'country','value'=>$country,'maxlength'=>64,'id'=>'Country','class'=>'input-xlarge');
					echo form_input($input);
				?>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<?php
					$input = array('name'=>'province','value'=>$province,'maxlength'=>64,'id'=>'Province','class'=>'input-xlarge');
					echo form_input($input);
				?>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<?php
					$input = array('name'=>'city','value'=>$city,'maxlength'=>64,'id'=>'City','class'=>'input-xlarge');
					echo form_input($input);
				?>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php
					$txtarea = array('name'=>'address','value'=>$address,'rows'=>2,'class'=>'span7');
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php
					$input = array('name'=>'email','value'=>$email,'maxlength'=>64,'id'=>'Email','class'=>'input-large');
					echo form_input($input);
				?>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php
					$input = array('name'=>'bank_account','value'=>$bank_account,'maxlength'=>64,'id'=>'BankAccount','class'=>'input-medium','onkeypress'=>'return numbersonly(event)');
					echo form_input($input);
				?>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<?php
					echo form_dropdown('bank_name',$option_bank_name,$bank_name,'id="bank_name" class="span7"');
				?>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<?php
					$input = array('name'=>'account_name','value'=>$account_name,'maxlength'=>64,'id'=>'AccountName','class'=>'input-xlarge');
					echo form_input($input);
				?>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php
					$txtarea = array('name'=>'vission','value'=>$vission,'rows'=>3,'class'=>'span7');
					echo form_textarea($txtarea); 
				?>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<?php
					$txtarea = array('name'=>'mission','value'=>$mission,'rows'=>3,'class'=>'span7');
					echo form_textarea($txtarea); 
				?>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<?php
					echo form_checkbox('status',1,$status,'class="ace-switch ace-switch-3"'); 
				?>
				<span class="lbl"></span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php
					$input = array('name'=>'tax_country','value'=>$tax_country,'maxlength'=>64,'id'=>'TaxCountry','class'=>'input-small');
					echo form_input($input);
				?>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<?php
					$input = array('name'=>'tax_file','value'=>$tax_file,'maxlength'=>64,'id'=>'TaxFile','class'=>'input-large');
					echo form_input($input);
				?>
			</div>
		</div>
